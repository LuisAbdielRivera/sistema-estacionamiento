    ...
    <ul class="nav nav-tabs h-75">
        <li class="nav-item">
            <a href="menu.php" class="nav-link active h-75" aria-current="page">
                <img src="./imagenes/logo.jpg" alt="logo" width="50" class="rounded-circle">
            </a>
        </li>
        <li class="nav-item">
            <a href="#" onclick="cargarDiv('#contenido','registrar.php');" class="nav-link h-75 text-center">
        ...
        <li class="nav-item">
            <a href="#" onclick="cargarDiv('#contenido','cajones.php');" class="nav-link h-75 text-center">
        ...
        <li class="nav-item">
            <a href="#" onclick="cargarDiv('#contenido','clientes.php');" class="nav-link h-75 text-center">
        ...
        <li class="nav-item">
            <a href="#" onclick="cargarDiv('#contenido','vehiculos.php');" class="nav-link h-75 text-center">
        ...
        <li class="nav-item">
            <a href="#" onclick="cargarDiv('#contenido','tarifas.php');" class="nav-link h-75 text-center">
        ...
        <li class="nav-item">
            <a href="#" onclick="cargarDiv('#contenido','encargados.php');" class="nav-link h-75 text-center">
        ...
        <li class="nav-item">
            <a href="#" onclick="cargarDiv('#contenido','reportes.php');" class="nav-link h-75 text-center">
        ...
        <li class="nav-item ms-auto">
            <a href="#" onclick="salir();" class="nav-link h-75 text-center">
