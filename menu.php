...
<div class="row">
    ...
    <ul class="nav nav-tabs h-75">
        ...
        <li class="nav-item">
            <a href="#" onclick="cargarDiv('#contenido','./formularios-agregar/registrar.php');" class="nav-link h-75 text-center">
        ...
        <li class="nav-item">
            <a href="#" onclick="cargarDiv('#contenido','./formularios-agregar/cajones.php');" class="nav-link h-75 text-center">
        ...
        <li class="nav-item">
            <a href="#" onclick="cargarDiv('#contenido','./formularios-agregar/clientes.php');" class="nav-link h-75 text-center">
        ...
        <li class="nav-item">
            <a href="#" onclick="cargarDiv('#contenido','./formularios-agregar/vehiculos.php');" class="nav-link h-75 text-center">
        ...
        <li class="nav-item">
            <a href="#" onclick="cargarDiv('#contenido','./formularios-agregar/tarifas.php');" class="nav-link h-75 text-center">
        ...
        <li class="nav-item">
            <a href="#" onclick="cargarDiv('#contenido','./formularios-agregar/encargados.php');" class="nav-link h-75 text-center">
        ...
        <li class="nav-item">
            <a href="#" onclick="cargarDiv('#contenido','./formularios-agregar/reportes.php');" class="nav-link h-75 text-center">
